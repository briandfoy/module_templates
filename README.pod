...
Search|http://search.cpan.org/dist/[% module_dist %]> or
L<MetaCPAN|http://www.metacpan.org/module/[% module %]>:

=over 4

=item *	L<http://search.cpan.org/dist/[% module %]>

=item *	L<http://www.metacpan.org/module/[% module %]>
...
=item *	L<https://github.com/briandfoy/[% repo_name %]>

=back

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/[% repo_name %]/issues>:

=over 4

=item *	L<https://github.com/briandfoy/[% repo_name %]/issues>
