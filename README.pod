...
=head1 The «== $module » module

This is the I<README> for the L<«== $module »> Perl module.
...
To read about L<«== $module »>, look at the embedded documentation
...
L<MetaCPAN|http://www.metacpan.org/module/«== $module »>.
...
the source repository: L<https://github.com/«== $github_user »/«== $repo_name »>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/«== $github_user »/«== $repo_name »/issues>.
...
=item * L<https://bitbucket.com/«== $github_user »/«== $repo_name »>

=item * L<https://codeberg.org/«== $github_user »/«== $repo_name »>

=item * L<https://gitlab.com/«== $github_user »/«== $repo_name »>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify «== $module »-1.23.tar.gz --owner «== $github_user »
